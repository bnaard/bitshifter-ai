...
set -g pane-active-border-style "fg=#D79921,bg=#282828"
set -g pane-border-format "#[bg=#282828]#{?pane_active,#[fg=#D69F34]#[bold],#[fg=#B3A38A]} #{?client_prefix,PREFIX,NORMAL} #{pane_title} #{pane_current_command} #[bg=#282828,fg=#282828] "
