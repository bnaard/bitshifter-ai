...
**Status:** pending
**aibox CLI:** v0.28.0 → v0.28.2
**processkit:** v0.27.4

## Summary

aibox has been updated from v0.28.0 to v0.28.2. Review each section below
and discuss action items with the project owner.

## Breaking Changes

Every release between v0.28.0 and v0.28.2 is listed below.                  Review each; treat entries tagged as breaking as action items.
...
- [ ] Verify `/workspace/context/templates/processkit/v0.27.4/` snapshot directory exists
...
- [ ] Check `/workspace/context/migrations/pending/` for processkit content migration files:
      ...
      - **When reviewing template files like `AGENTS.md`:** do NOT diff the installed
        ...
        `diff context/templates/processkit/v0.27.4/AGENTS.md context/templates/processkit/v0.27.4/AGENTS.md`
...
processkit is tracking `version = "latest"` — installed: `v0.27.4` (upgraded from `v0.27.4` — aibox.toml now targets `vlatest`) (source: `https://github.com/projectious-work/processkit.git`).
...
- [ ] processkit version reference matches `aibox.lock` (`v0.27.4`)
