...
\chapter*{Disclaimer: AI-Assisted Document}
\addcontentsline{toc}{chapter}{Disclaimer}

This book was generated with substantial assistance from a large
...
\input{chapters/ch01_problem}
\input{chapters/ch02_boolean}
\input{chapters/ch03_learning}
\input{chapters/ch04_mnist_prep}

% Part II: Tsetlin Machines
\part{Tsetlin Machines --- Learning Logic Without Gradients}
\label{part:tsetlin}

\input{chapters/ch05_automaton}
\input{chapters/ch06_clauses}
\input{chapters/ch07_tm_mnist}

% Part III: Logic Gate Networks
\part{Logic Gate Networks --- Learning the Circuit}
\label{part:lgn}

\input{chapters/ch08_diff_gates}
\input{chapters/ch09_lgn_training}

% Part IV: LUT Compilation
\part{LUT Compilation --- From Functions to Tables}
\label{part:lut}

\input{chapters/ch10_splines}
\input{chapters/ch11_lut}

% Part V: The Complete System
\part{The Complete Hybrid Architecture}
\label{part:hybrid}

\input{chapters/ch12_assembly}
\input{chapters/ch13_analysis}
\input{chapters/ch14_implementation}
