...
\begin{tabular}{@{}p{3.2cm}p{2.5cm}p{6.5cm}@{}}
  ...
  Layer normalisation  & \textbf{Replaceable} & Integer normalisation via I-BERT~\cite{kim2021ibert}, I-ViT~\cite{li2022ivit}, and I-LLM~\cite{hu2024illm}. See \cref{sec:layernorm-problem}. \\
