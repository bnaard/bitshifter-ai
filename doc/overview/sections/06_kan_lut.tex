...
\begin{description}[leftmargin=1em]
  \item[Strengths:]
    ...
    accuracy among bitwise-deployable approaches, LUT compilation enables
    table-driven inference, and CPU-based edge deployment has been
    demonstrated~\cite{lutkan2025}. The key CPU trade-off is cache
    residency: small, per-feature tables can be effective, while large or
    scattered tables turn a nominally arithmetic-free layer into a
