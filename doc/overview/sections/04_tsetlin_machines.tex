...
\begin{table}[htbp]
\centering
\caption{Tsetlin Machine results on MNIST~\cite{granmo2018tsetlin}.}
\label{tab:tm-mnist}
\begin{tabular}{@{}lrr@{}}
  \toprule
  \textbf{Configuration}     & \textbf{Accuracy} & \textbf{Clauses} \\
  \midrule
  Basic TM (8,000 clauses)   & 98.2\%            & 8,000 \\
  Convolutional TM            & 99.1\%            & 16,000 \\
  State-of-art TM             & 99.35\%           & Millions \\
  \bottomrule
\end{tabular}
\end{table}
